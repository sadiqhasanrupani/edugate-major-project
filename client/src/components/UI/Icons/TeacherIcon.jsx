        ...
        <g id="vuesax/bulk/people_2">
          <g id="people">
            ...
            <path
              id="Vector_2"
              opacity="0.4"
              d="M20.7896 14.7C19.6696 15.45 18.0996 15.73 16.6496 15.54C17.0296 14.72 17.2296 13.81 17.2396 12.85C17.2396 11.85 17.0196 10.9 16.5996 10.07C18.0796 9.87001 19.6496 10.15 20.7796 10.9C22.3596 11.94 22.3596 13.65 20.7896 14.7Z"
              fill="#7959FD"
            />
            <path
              id="Vector_3"
