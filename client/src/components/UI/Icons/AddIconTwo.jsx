...
const AddIconTwo = () => {
  return (
    ...
    >
      <path
        opacity="0.4"
        d="M26.5 15C26.5 21.3513 21.3513 26.5 15 26.5C8.64873 26.5 3.5 21.3513 3.5 15C3.5 8.64873 8.64873 3.5 15 3.5C21.3513 3.5 26.5 8.64873 26.5 15Z"
        fill="#7959FD"
        stroke="white"
        strokeWidth="2"
      />
